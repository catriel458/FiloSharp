    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="p-4">
        <nav className="space-y-2">
          <Link
            to="/admin/dashboard"
            className={`block px-4 py-2 rounded-md transition-colors ${isActive('/admin/dashboard') ? activeClass : inactiveClass}`}
          >
          ...
          <Link
            to="/admin/orders"
            className={`block px-4 py-2 rounded-md transition-colors ${isActive('/admin/orders') ? activeClass : inactiveClass}`}
          >
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link
            to="/admin/users"
            className={`block px-4 py-2 rounded-md transition-colors ${isActive('/admin/users') ? activeClass : inactiveClass}`}
          >
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link
            to="/admin/settings"
            className={`block px-4 py-2 rounded-md transition-colors ${isActive('/admin/settings') ? activeClass : inactiveClass}`}
          >
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
